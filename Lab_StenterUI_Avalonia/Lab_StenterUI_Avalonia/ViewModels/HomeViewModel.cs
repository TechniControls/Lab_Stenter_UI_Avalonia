...
public class HomeViewModel : ViewModelBase
{
     private readonly RecipesModel _recipesModel;
        ...
        public Brush ColorMachineStatus =>
            CurrentMachineStatus ? new SolidColorBrush(Colors.Green) : new SolidColorBrush(Colors.Orange);

        // Alarms Status
        public string AlarmsStatus =>
            CurrentAlarmsStatus ? "Active" : "Inactive";
        public Brush ColorAlarmsStatus =>
            CurrentAlarmsStatus ? new SolidColorBrush(Colors.Red) : new SolidColorBrush(Colors.Green);
